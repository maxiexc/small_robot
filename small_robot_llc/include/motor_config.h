...
#define MOTOR_DDUTY_MAX001    (20.0)     
#define MOTOR_DUTY_MAX_ABS    (1.0)
#define MOTOR_DUTY_MIN_ABS    (0.15)

/*Contorller  related parameters*/
#define MOTOR_ERR_THD         2       /*Deadzone for motor controller in PPS*/
#define MOTOR_SPEED_CONTROLLER_KP (0.015)
#define MOTOR_SPEED_CONTROLLER_KD (0.0)
